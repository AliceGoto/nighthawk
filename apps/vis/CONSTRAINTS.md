...
会话可视化工具：浏览器中查看 session 与 replay。

## 开发提示词

当要求 AI 修改 `apps/vis` 时，必须使用以下提示词框架：
...
```sh
pnpm -C apps/vis typecheck
pnpm -C apps/vis test
```

## 相关文档

- `project-encyclopedia/03-packages/vis/`（包文档）
