...
VS Code 扩展：侧边栏 webview 聊天、文件插入、会话管理、v1/v2 引擎切换。

## 开发提示词

当要求 AI 修改 `apps/vscode` 时，必须使用以下提示词框架：
...
```sh
pnpm -C apps/vscode typecheck
pnpm -C apps/vscode test
```

## 相关文档

- `project-encyclopedia/03-packages/vscode/`（包文档）
