...
主 CLI/TUI 应用：参数解析、TUI、headless、更新、迁移、native/SEA 打包。

## 开发提示词

当要求 AI 修改 `apps/nighthawk` 时，必须使用以下提示词框架：
...
```markdown
- 只修改 `apps/nighthawk` 下与任务直接相关的文件。
- 不破坏该包的公开导出和协议兼容性。
- 新功能必须包含测试。
...
- `project-encyclopedia/03-packages/nighthawk/`（包文档）
