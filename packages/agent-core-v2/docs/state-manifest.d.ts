...
// Regenerate with: pnpm --filter @nighthawk/agent-core-v2 gen:state-manifest
//
...
//     pentestMode                                     src/agent/pentestMode/pentestModeOps.ts
...
export interface WorkspaceStateSnapshot {
  ...
  'workspaceSkillCatalog.merged': /* InMemorySkillCatalog — packages/agent-core-v2/src/features/skill/catalog/registry.ts */ {
    ...
    getNighthawkSkillsDescription: () => string;
...
export interface AgentStateSnapshot {
  ...
  // src/agent/pentestMode/pentestModeOps.ts
  // replayable · durable — folds: PentestModeEnter, PentestModeExit
  'pentestMode': boolean;
