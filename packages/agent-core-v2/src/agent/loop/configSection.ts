...
export const LOOP_MAX_STEPS_PER_TURN_ENV = 'NIGHTHAWK_LOOP_MAX_STEPS_PER_TURN';
export const LOOP_MAX_ATTEMPTS_PER_STEP_ENV = 'NIGHTHAWK_LOOP_MAX_ATTEMPTS_PER_STEP';
/** Deprecated former name of {@link LOOP_MAX_ATTEMPTS_PER_STEP_ENV}. */
export const LOOP_MAX_RETRIES_PER_STEP_ENV = 'NIGHTHAWK_LOOP_MAX_RETRIES_PER_STEP';
...
export const LoopControlSchema = z.object({
  ...
  compactionRetentionRatio: z.number().min(0.01).max(1).optional(),
});
