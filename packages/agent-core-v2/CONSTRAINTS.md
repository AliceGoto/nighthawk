...
当要求 AI 修改 `packages/agent-core-v2` 时，必须使用以下提示词框架：

```text
请修改 packages/agent-core-v2。
...
```markdown
- 只修改 `packages/agent-core-v2` 下与任务直接相关的文件。
- 不破坏该包的公开导出和协议兼容性。
- 新功能必须包含测试。
...
- `project-encyclopedia/03-packages/agent-core-v2/`（包文档）
