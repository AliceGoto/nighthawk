...
import type { NighthawkConfig } from '../../../src/config';
...
describe('FullCompaction', () => {
  it('runs manual compaction and applies the compacted context', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] llm.request                { "kind": "compaction", "provider": "nighthawk", "model": "nighthawk", "modelAlias": "nighthawk", "thinkingEffort": "off", "maxTokens": 16384, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "messageCount": 7, "droppedCount": 0, "time": "<time>" }
      [wire] usage.record               { "model": "nighthawk", "usage": { "inputOther": 1235, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "nighthawk", "contextTokens": 120, "maxContextTokens": 256000, "contextUsage": 0.00046875, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1235, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1235, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated       { "model": "nighthawk", "contextTokens": 158, "maxContextTokens": 256000, "contextUsage": 0.0006171875, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1235, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1235, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('force-refreshes OAuth credentials on compaction 401 and treats replay 401 as provider auth error', async () => {
    ...
    ctx.configure();
    await ctx.rpc.setModel({ model: 'nighthawk' });
    ctx.newEvents();
    ctx.appendExchange(1, 'old user one', 'old assistant one', 20);
  ...
  it('fires PreCompact and PostCompact hooks from the compaction module', async () => {
    const dir = mkdtempSync(join(tmpdir(), 'nighthawk-compact-hooks-'));
  ...
  it('keeps messages appended while compacting an unchanged prefix', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record               { "model": "nighthawk", "usage": { "inputOther": 1206, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "nighthawk", "contextTokens": 80, "maxContextTokens": 256000, "contextUsage": 0.0003125, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1206, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1206, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated       { "model": "nighthawk", "contextTokens": 160, "maxContextTokens": 256000, "contextUsage": 0.000625, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1206, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1206, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete   { "time": "<time>" }
  ...
  it('cancels when the compacted prefix changes before completion', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated     { "model": "nighthawk", "contextTokens": 0, "maxContextTokens": 256000, "contextUsage": 0, "planMode": false, "swarmMode": false, "permission": "manual" }
      [wire] llm.tools_snapshot       { "hash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "tools": [], "time": "<time>" }
      [wire] llm.request              { "kind": "compaction", "provider": "nighthawk", "model": "nighthawk", "modelAlias": "nighthawk", "thinkingEffort": "off", "maxTokens": 16384, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "messageCount": 5, "droppedCount": 0, "time": "<time>" }
      [wire] usage.record             { "model": "nighthawk", "usage": { "inputOther": 1206, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated     { "model": "nighthawk", "contextTokens": 0, "maxContextTokens": 256000, "contextUsage": 0, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1206, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1206, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('blocks the turn until auto compaction finishes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record                { "model": "nighthawk", "usage": { "inputOther": 1227, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated        { "model": "nighthawk", "contextTokens": 950000, "maxContextTokens": 256000, "contextUsage": 3.7109375, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1227, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1227, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated        { "model": "nighthawk", "contextTokens": 166, "maxContextTokens": 256000, "contextUsage": 0.0006484375, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1227, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1227, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete    { "time": "<time>" }
      ...
      [wire] llm.request                 { "kind": "loop", "provider": "nighthawk", "model": "nighthawk", "modelAlias": "nighthawk", "thinkingEffort": "off", "maxTokens": 255834, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "messageCount": 2, "turnStep": "0.1", "time": "<time>" }
      ...
      [wire] usage.record                { "model": "nighthawk", "usage": { "inputOther": 165, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "turn", "time": "<time>" }
      [emit] agent.status.updated        { "model": "nighthawk", "contextTokens": 176, "maxContextTokens": 256000, "contextUsage": 0.0006875, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "nighthawk": { "inputOther": 1392, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1392, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 165, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('preserves thinking effort when compacting after provider context overflow', async () => {
    ...
    expect(callCount).toBe(3);
    // A NightHawk model without supportEfforts is boolean-only, so the effective
  ...
  it('honors completion budget env hard caps during compaction', async () => {
    vi.stubEnv('NIGHTHAWK_MODEL_MAX_COMPLETION_TOKENS', '8192');
    let callCount = 0;
    const compactionMaxCompletionTokens: unknown[] = [];
    const generate: GenerateFn = async (provider, _system, _tools, _history, callbacks) => {
      callCount += 1;
  ...
  it('honors completion budget env opt-out during compaction', async () => {
    vi.stubEnv('NIGHTHAWK_MODEL_MAX_COMPLETION_TOKENS', '0');
    let callCount = 0;
    const compactionMaxCompletionTokens: unknown[] = [];
    const generate: GenerateFn = async (provider, _system, _tools, _history, callbacks) => {
      callCount += 1;
  ...
  it('honors maxOutputSize from model config during compaction', async () => {
    ...
    // Set maxOutputSize on the harness's internal nighthawkConfig — the
    // compaction path reads it via ConfigState.maxOutputSize.
    const models = (ctx as unknown as { nighthawkConfig: NighthawkConfig }).nighthawkConfig.models;
  ...
  it('uses default 16k hardCap when maxOutputSize is not configured', async () => {
    let callCount = 0;
    const compactionMaxCompletionTokens: unknown[] = [];
    const generate: GenerateFn = async (provider, _system, _tools, _history, callbacks) => {
      callCount += 1;
    ...
    expect(callCount).toBe(3);
    expect(compactionMaxCompletionTokens).toEqual([16 * 1024]);
  });
  ...
  it('emits context.overflow and terminates the turn after too many auto compactions', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] compaction.blocked          { "turnId": 0 }
      [wire] llm.tools_snapshot          { "hash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "tools": [], "time": "<time>" }
      [wire] llm.request                 { "kind": "compaction", "provider": "nighthawk", "model": "mock-model", "modelAlias": "mock-model", "thinkingEffort": "off", "maxTokens": 16384, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "messageCount": 2, "droppedCount": 0, "time": "<time>" }
      [wire] usage.record                { "model": "mock-model", "usage": { "inputOther": 1189, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated        { "model": "mock-model", "contextTokens": 0, "maxContextTokens": 1000000, "contextUsage": 0, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "mock-model": { "inputOther": 1189, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1189, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated        { "model": "mock-model", "contextTokens": 165, "maxContextTokens": 1000000, "contextUsage": 0.000165, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "mock-model": { "inputOther": 1343, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1343, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 154, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [emit] turn.step.interrupted       { "turnId": 0, "step": 2, "reason": "error", "message": "Compaction limit exceeded (1)" }
      [emit] turn.ended                  { "turnId": 0, "reason": "failed", "error": { "code": "context.overflow", "message": "Compaction limit exceeded (1)", "name": "NighthawkError", "details": { "maxCompactions": 1, "turnId": 0 }, "retryable": true } }
    `);
    expect(ctx.newEvents()).toMatchInlineSnapshot(
      `[emit] error   { "code": "context.overflow", "message": "Compaction limit exceeded (1)", "name": "NighthawkError", "details": { "maxCompactions": 1, "turnId": 0 }, "retryable": true }`,
    );
    expect(ctx.llmInputs()).toMatchInlineSnapshot(`
      call 1:
        system: <system-prompt>
...
function getMicroCompactionFlagEnv(): string {
  ...
  return 'NIGHTHAWK_EXPERIMENTAL_MICRO_COMPACTION';
}
